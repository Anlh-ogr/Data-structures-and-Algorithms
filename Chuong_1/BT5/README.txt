...
The sum of the two polynomials is:      => The polynomial is: 3x^4 + 9x^3 + 9x^2 + 9x + 9

The product of the two polynomials is:  => The polynomial is: 15x^7 + 32x^6 + 50x^5 + 68x^4 + 82x^3 + 56x^2 + 33x + 14